...
mysqldump --single-transaction --routines --triggers --host=$DatabaseHost --user=$DatabaseUser --password=$DatabasePassword --databases $DatabaseName | Out-File -FilePath $target -Encoding utf8
