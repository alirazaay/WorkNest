...
User.init({
  ...
  email: { type: DataTypes.STRING(255), allowNull: false, unique: true }, avatarUrl: { type: DataTypes.STRING(1000), field: 'avatar_url' }, passwordHash: { type: DataTypes.STRING(255), allowNull: false, field: 'password_hash' },
