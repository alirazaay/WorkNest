...
EmployeeSalaryStructure.init({
  ...
  medicalAllowance: { type: DataTypes.DECIMAL(12, 2), defaultValue: 0, field: 'medical_allowance' }, taxDeduction: { type: DataTypes.DECIMAL(12, 2), defaultValue: 0, field: 'tax_deduction' }, otherDeductions: { type: DataTypes.DECIMAL(12, 2), defaultValue: 0, field: 'other_deductions' }, currency: { type: DataTypes.STRING(3), defaultValue: 'PKR' }, payFrequency: { type: DataTypes.STRING(20), defaultValue: 'monthly', field: 'pay_frequency' }, createdBy: { type: DataTypes.INTEGER, field: 'created_by' }
