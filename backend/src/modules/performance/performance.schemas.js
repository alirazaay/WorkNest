...
export const trainingNeedQuerySchema = z.object({ employeeId: z.coerce.number().int().positive().optional(), priority: z.enum(['low', 'medium', 'high', 'critical']).optional(), status: z.enum(['identified', 'reviewed', 'approved', 'planned', 'in_progress', 'completed', 'dismissed']).optional(), signalCode: z.string().max(80).optional() });
